...
@Component({
  ...
  `,
  styles: [`
    .slide-form-container{position:fixed;inset:0;background:linear-gradient(135deg,#f093fb 0%,#f5576c 50%,#4facfe 100%);z-index:1000;overflow:hidden}
    .slide-header{position:absolute;top:0;left:0;right:0;padding:20px;background:rgba(255,255,255,.95);backdrop-filter:blur(10px);z-index:10;box-shadow:0 2px 10px rgba(0,0,0,.1)}
    .close-btn{position:absolute;top:20px;right:20px;font-size:32px;color:#6b7280;text-decoration:none;width:40px;height:40px;display:flex;align-items:center;justify-content:center;border-radius:50%;transition:all .2s;z-index:11}
    .close-btn:hover{background:#f3f4f6;color:#f5576c}
    .progress-bar{width:100%;height:4px;background:#e5e7eb;border-radius:2px;overflow:hidden;margin-top:40px}
    .progress-fill{height:100%;background:linear-gradient(90deg,#f093fb 0%,#f5576c 100%);transition:width .3s;border-radius:2px}
    .slide-indicator{text-align:center;margin-top:10px;font-size:14px;color:#6b7280;font-weight:500}
    .slides-wrapper{position:absolute;top:120px;left:0;right:0;bottom:0;overflow:hidden}
    .slides-container{display:flex;height:100%;transition:transform .5s cubic-bezier(.4,0,.2,1)}
    .slide{min-width:100%;height:100%;display:flex;align-items:center;justify-content:center;padding:40px 20px;overflow-y:auto}
    .slide-content{max-width:600px;width:100%;background:#fff;border-radius:24px;padding:40px;box-shadow:0 20px 60px rgba(0,0,0,.2);animation:slideIn .5s}
    @keyframes slideIn{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}
    .slide-icon{font-size:64px;text-align:center;margin-bottom:20px}
    .slide-content h2{text-align:center;font-size:2rem;margin:0 0 10px;background:linear-gradient(135deg,#f093fb 0%,#f5576c 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
    .slide-subtitle{text-align:center;color:#6b7280;margin:0 0 30px;font-size:16px}
    .input-group{margin-bottom:24px}
    .input-group label{display:block;margin-bottom:12px;font-weight:600;color:#374151;font-size:14px}
    .slide-input,.slide-textarea{width:100%;padding:16px;border:2px solid #e5e7eb;border-radius:12px;font-size:16px;transition:all .2s;font-family:inherit}
    .slide-input:focus,.slide-textarea:focus{outline:none;border-color:#f5576c;box-shadow:0 0 0 3px rgba(245,87,108,.1)}
    .slide-textarea{resize:vertical;min-height:120px}
    .error-message{color:#ef4444;font-size:14px;margin-top:8px}
    .category-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:20px}
    .category-card,.partner-card,.status-card{padding:20px;border:2px solid #e5e7eb;border-radius:16px;background:#fff;cursor:pointer;transition:all .2s;text-align:center}
    .category-card:hover,.partner-card:hover,.status-card:hover{border-color:#f5576c;transform:translateY(-2px)}
    .category-card.active,.partner-card.active,.status-card.active{border-color:#f5576c;background:linear-gradient(135deg,#fef2f2 0%,#fce7f3 100%)}
    .category-card.active{box-shadow:0 4px 12px rgba(245,87,108,.3)}
    .category-icon,.partner-icon,.status-icon{font-size:32px;margin-bottom:8px}
    .category-name,.partner-label,.status-label{font-size:14px;font-weight:600;color:#1f2937}
    .partner-section{display:flex;flex-direction:column;gap:24px}
    .partner-options{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}
    .status-options{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}
    .checkbox-label{display:flex;align-items:center;gap:12px;cursor:pointer;padding:16px;border:2px solid #e5e7eb;border-radius:12px;transition:all .2s}
    .checkbox-label:hover{border-color:#f5576c;background:#fef2f2}
    .checkbox-label input[type="checkbox"]{width:20px;height:20px;cursor:pointer}
    .photo-upload-section{margin-bottom:24px}
    .photo-upload-btn{width:100%;padding:16px;border:2px dashed #e5e7eb;border-radius:12px;background:#f9fafb;cursor:pointer;font-size:16px;font-weight:600;color:#6b7280;transition:all .2s}
    .photo-upload-btn:hover{border-color:#f5576c;background:#fef2f2;color:#f5576c}
    .photo-preview-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(100px,1fr));gap:12px;margin-top:16px}
    .photo-preview-item{position:relative;aspect-ratio:1;border-radius:12px;overflow:hidden;border:2px solid #e5e7eb}
    .photo-preview-item img{width:100%;height:100%;object-fit:cover}
    .remove-photo{position:absolute;top:4px;right:4px;width:24px;height:24px;border-radius:50%;background:rgba(239,68,68,.9);color:#fff;border:none;cursor:pointer;font-size:16px;display:flex;align-items:center;justify-content:center;line-height:1}
    ...
    .star-btn{background:none;border:none;font-size:40px;cursor:pointer;padding:0;opacity:.3;transition:all .2s;filter:grayscale(100%)}
    .star-btn.active{opacity:1;filter:grayscale(0);transform:scale(1.1)}
    .star-btn:hover{opacity:.7;filter:grayscale(50%)}
    .rating-text{font-size:16px;font-weight:600;color:#6b7280}
    .slide-actions{display:flex;gap:12px;margin-top:30px;justify-content:space-between}
    .btn-back,.btn-next,.btn-submit{padding:16px 32px;border:none;border-radius:12px;font-size:16px;font-weight:600;cursor:pointer;transition:all .2s}
